...
# In
print(get_res_value(['br', 'bk', 'yl', 'ag']))
print(get_res_value(['yl', 'vi', 'rd', 'au']))
print(get_res_value(['vi', 'yl', 'rd', 'gr']))
print(get_res_value(['ws', 'yl', 'rd', 'rd']))
print(get_res_value(['vi', 'yl', 'rd']))